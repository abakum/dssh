...
6. Если на sshd.lan запущен sshd то чтоб увидень рабочий стол vncserver.lan на vncviewer.lan запустите `dssh -077 sshd.lan` а на vncserver.wan запустите `dssh -s77 sshd.lan`.
