...
Что было доделанно в tssh:
    ...
    12. Возможность прервать по Ctr-C dynamicForward, localForward, remoteForward используя restoreStdFuncs.Cleanup перед ss.client.Wait в sshStart из main.go.
