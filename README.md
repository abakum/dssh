...
# Как использовать для доступа к удалённой последовательной консоли:
    ...
    5.  Дальше как в разделе `Как использовать для доступа к локальной последовательной консоли` (Для Виндос через ssh используется plink или telnet)
...
# Как использовать для совместного доступа к последовательной консоли нескольких клиентов:
    ...
    5.  Другие клиенты могут тоже подключится к порту 7000 командой `dssh -2 7000 :` и управлять последовательной консолью на порте COM7 со скоростью 115200.
    6.  Можно подключится и к сервису ser2net.
