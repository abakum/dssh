...
10. Как в [1.9](#1.9) но через http&#65279;://127.0.0.1:8009 `dssh -8 8009 127.0.0.1` или короче `dssh -89 +`. Иногда порты на 127.0.0.1 блокируется политикой безопасности. Тогда вместо (1.8)[#1.8] или (1.10)[#1.10] можно использовать (1.9)[#1.9].<div id=1.11>
